...
**Pending, not claimed:** cost actuals. Cost Explorer still returns `Estimated: true` for every day this organization has existed; the earliest defensible retry is 2026-08-02. The projection in `docs/cost.md` is labelled a projection.
...
- [x] Demo recording
- [ ] Cost actuals — earliest closed Cost Explorer window 2026-08-02
